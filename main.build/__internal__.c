...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_1__mro_entries_conversion( PyObject **python_pars )
{
    ...
    goto branch_end_2;
    branch_no_2:;
    tmp_hasattr_source_1 = tmp_base;

    CHECK_OBJECT( tmp_hasattr_source_1 );
    tmp_hasattr_attr_1 = const_str_plain___mro_entries__;
    ...
    tmp_called_name_1 = LOOKUP_ATTRIBUTE( tmp_source_name_1, const_str_plain___mro_entries__ );
...

    {
        ...
        tmp_value_name_2 = CALL_FUNCTION_WITH_ARGS1( tmp_called_name_1, call_args );
    }
