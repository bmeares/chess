...
MOD_INIT_DECL( square );
MOD_INIT_DECL( utils );
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    { "Canvas", MOD_INIT_NAME( Canvas ), 0, 0, NUITKA_COMPILED_MODULE },
    { "Player", MOD_INIT_NAME( Player ), 0, 0, NUITKA_COMPILED_MODULE },
    { "__main__", MOD_INIT_NAME( __main__ ), 0, 0, NUITKA_COMPILED_MODULE },
    { "board", MOD_INIT_NAME( board ), 0, 0, NUITKA_COMPILED_MODULE },
    { "globVar", MOD_INIT_NAME( globVar ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pieces", MOD_INIT_NAME( pieces ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "pieces.bishop", MOD_INIT_NAME( pieces$bishop ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pieces.king", MOD_INIT_NAME( pieces$king ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pieces.knight", MOD_INIT_NAME( pieces$knight ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pieces.pawn", MOD_INIT_NAME( pieces$pawn ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pieces.piece", MOD_INIT_NAME( pieces$piece ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pieces.queen", MOD_INIT_NAME( pieces$queen ), 0, 0, NUITKA_COMPILED_MODULE },
    { "pieces.rook", MOD_INIT_NAME( pieces$rook ), 0, 0, NUITKA_COMPILED_MODULE },
    { "square", MOD_INIT_NAME( square ), 0, 0, NUITKA_COMPILED_MODULE },
    { "utils", MOD_INIT_NAME( utils ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
